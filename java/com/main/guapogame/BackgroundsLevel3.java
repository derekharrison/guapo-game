...
public class BackgroundsLevel3 extends Backgrounds {
    ...
    public int num_backgrounds = 11;

    BackgroundsLevel3(GameActivityLevel3 activity, int screenX, int screenY, Resources res) {
        ...
        for(int i = 1; i <= num_backgrounds; ++i) {
            ...
            int resourceId = resources.getIdentifier("background_guapo_game_level3_" + i, "drawable", activity.getPackageName());
