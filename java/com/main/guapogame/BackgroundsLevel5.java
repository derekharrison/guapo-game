...
public class BackgroundsLevel5 extends Backgrounds{
    ...
    public int num_backgrounds = 18;

    BackgroundsLevel5(GameActivityLevel5 activity, int screenX, int screenY, Resources res) {
        ...
        for(int i = 1; i <= num_backgrounds; ++i) {
            ...
            int resourceId = resources.getIdentifier("background_tuttigame_nr" + i, "drawable", activity.getPackageName());
